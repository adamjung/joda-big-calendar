...
var _event = require('./utils/dayViewLayout/event');
...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.render = function render() {
    ...
    var eventsRendered = this.renderEvents(range, rangeEvents, now, resources || [null]);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_TimeColumn2.default, _extends({}, this.props, {
          min: _dates2.default.startOf(start, 'day'),
          max: _dates2.default.endOf(start, 'day'),
          showLabels: true,
          style: { width: width },
          ref: gutterRef,
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(range, events, today, resources) {
    ...
    return range.map(function (date, idx) {
      var daysEvents = events.filter(function (event) {
        return (0, _eventLevels.inRange)(event, _dates2.default.startOf(date, 'day'), _dates2.default.endOf(date, 'day'), {
          timezone: timezone,
      ...
      return resources.map(function (resource, id) {
        ...
        return _react2.default.createElement(_DayColumn2.default, _extends({}, _this4.props, {
          min: _dates2.default.startOf(_dates2.default.merge(date, min), 'day'),
          max: _dates2.default.endOf(_dates2.default.merge(date, max), 'day'),
  ...
  TimeGrid.prototype.calculateScroll = function calculateScroll() {
    ...
    var totalMillis = _dates2.default.diff(min, max);
  ...
  TimeGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
    ...
    var current = getNow();
    var zonedMin = (0, _event.convertToTimezone)(min, timezone);
    var zonedMax = (0, _event.convertToTimezone)(max, timezone);

    var secondsPassed = _dates2.default.diff(_dates2.default.startOf(current, 'day'), current, 'seconds');

    var timeIndicator = this.refs.timeIndicator;
    var factor = secondsPassed / secondsTotal % 1;
    var timeGutter = this._gutters[this._gutters.length - 1];

    if (timeGutter && _dates2.default.gte(current, zonedMin) && _dates2.default.lte(current, zonedMax)) {
...
TimeGrid.propTypes = {
  ...
  range: _propTypes2.default.arrayOf(_propTypes2.default.object),
  min: _propTypes2.default.object.isRequired,
  max: _propTypes2.default.object.isRequired,
  getNow: _propTypes2.default.func.isRequired,

  scrollToTime: _propTypes2.default.object,
...
TimeGrid.defaultProps = {
  step: 30,
  scrollToTime: _dates2.default.startOf(_jsJoda.ZonedDateTime.now(), 'day'),
