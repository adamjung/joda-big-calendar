...
var TimeGrid = (function(_Component) {
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(
    ...
    return range.map(function(date, idx) {
      var daysEvents = events.filter(function(event) {
        return (0,
        _eventLevels.inRange)(event, _dates2.default.startOf(date, 'day'), _dates2.default.endOf(date, 'day'), {
          timezone: timezone,
      ...
      return resources.map(function(resource, id) {
        ...
        return _react2.default.createElement(
          ...
          _extends({}, _this4.props, {
            min: _dates2.default.startOf(
              _dates2.default.merge(date, min),
              'day'
            ),
  ...
  TimeGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
    ...
    var secondsPassed = _dates2.default.diff(
      _dates2.default.startOf(current, 'day'),
      current,
      'seconds'
    )
    ...
    if (
      timeGutter &&
      _dates2.default.gte(current, zonedMin) &&
      _dates2.default.lte(current, zonedMax)
    ) {
