...
var _jsJodaTimezone = require('js-joda-timezone');

var _jsJodaTimezone2 = _interopRequireDefault(_jsJodaTimezone);
...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'timezone', 'onTzChange', 'components', 'formats', 'messages', 'style', 'className', 'elementProps', 'date', 'length']);

    current = (0, _event.convertToTimezone)(current || this.getNow(), timezone);
...
Calendar.propTypes = {
  ...
  onTzChange: _propTypes2.default.func,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getNow = function () {
    var timezone = _this2.props.timezone;

    var now = _jsJoda.ZonedDateTime.now(timezone && _jsJoda.ZoneId.of(timezone));
    return _jsJoda.ZonedDateTime.now(timezone && _jsJoda.ZoneId.of(timezone));
  };
