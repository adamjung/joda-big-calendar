  ...
  BackgroundCells.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      range.map(function (date, index) {
        ...
        var isToday = _dates2.default.eq(date, current, 'day');
        return _react2.default.createElement(
          Wrapper,
          { key: index, value: date, range: range },
          _react2.default.createElement('div', {
            style: styles,
            className: (0, _classnames2.default)('rbc-day-bg', className, selected && 'rbc-selected-cell', isToday && 'rbc-today', currentDate && _dates2.default.month(currentDate) !== _dates2.default.month(date) && 'rbc-off-range-bg')
          })
        );
      })
    );
