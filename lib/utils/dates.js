...
;(0, _jsJoda.use)(_jsJodaTimezone2.default)
...
var dates = _extends({}, _jodaDateArithmetic2.default, {
  monthsInYear: function monthsInYear(year, timezone) {
    ...
    var date = _jsJoda.ZonedDateTime.of(
      datetime,
      timezone || _jsJoda.ZoneId.SYSTEM
    )
  ...
  today: function today(timezone) {
    return dates.startOf(
      _jsJoda.ZonedDateTime.now(timezone || _jsJoda.ZoneId.SYSTEM),
      'day'
    )
  },
