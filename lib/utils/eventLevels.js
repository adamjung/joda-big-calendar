...
function eventSegments(event, first, last, _ref, // props
range) {
  ...
  var zonedStart = (0, _event.convertToTimezone)((0, _accessors.accessor)(event, startAccessor), timezone);
  var zonedEnd = (0, _event.convertToTimezone)((0, _accessors.accessor)(event, endAccessor), timezone);

  var start = _dates2.default.max(_dates2.default.startOf(zonedStart, 'day'), first);
...
function inRange(e, rangeStart, rangeEnd, _ref2) {
  ...
  var zonedStart = (0, _event.convertToTimezone)((0, _accessors.accessor)(e, startAccessor), timezone);
  var zonedEnd = (0, _event.convertToTimezone)((0, _accessors.accessor)(e, endAccessor), timezone);
  ...
  var eEnd = (0, _event.convertToTimezone)((0, _accessors.accessor)(e, endAccessor), timezone);

  var startsBeforeEnd = _dates2.default.lte(eStart, zonedRangeEnd, 'day');
  // when the event is zero duration we need to handle a bit differently
  var endsAfterStart = !_dates2.default.eq(eStart, zonedRangeEnd, 'minutes') ? _dates2.default.gt(eEnd, zonedRangeStart, 'minutes') : _dates2.default.gte(eEnd, zonedRangeStart, 'minutes');
